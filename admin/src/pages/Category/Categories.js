...
const Categories = () => {
  ...
  const fetchCategories = async () => {
    try {
      const response = await fetch('https://demotents-backend.onrender.com/api/categories?includeSubCategories=true');
  ...
  const handleEditCategory = async (e) => {
    ...
    try {
      const response = await fetch(`https://demotents-backend.onrender.com/api/categories/${currentCategory.id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleDeleteCategory = async (categoryId) => {
    ...
    try {
      const response = await fetch(`https://demotents-backend.onrender.com/api/categories/${categoryId}`, {
        method: 'DELETE',
      });
