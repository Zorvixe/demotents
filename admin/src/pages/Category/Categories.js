          ...
          <div className="inventory-table-container"><table className="inventory-table"><thead><tr><th width="25%">Category Name</th><th width="30%">Description</th><th width="15%">Products</th><th width="20%">Sub-categories</th><th width="10%">Actions</th></tr></thead><tbody>
            {paginatedCategories.map((category) => (
              <tr key={category.id} className="inventory-row">
                ...
                <td className="cell-actions"><button onClick={() => openEditModal(category)} className="action-btn edit-btn" title="Edit Category">Edit</button><button onClick={() => confirmDeleteCategory(category.id, category.name)} className="action-btn delete-btn" title="Delete Category">Delete</button></td>
              </tr>
            ))}
          </tbody></table></div>
